...
const STRINGS = {
  ...
  es: {
    ...
    reviewTitle: 'Revisa y completa los campos',
    ...
    adoptTitle: 'Adopta tu firma',
    adoptIntro: 'Dibuja o escribe tu firma. Se aplicará a los campos de firma de este documento.',
    draw: 'Dibujar',
    type: 'Escribir',
    typedPlaceholder: 'Escribe tu nombre completo',
    clear: 'Borrar',
    ...
    declineIntro: 'Si rechazas, avisaremos al remitente. Puedes indicar el motivo abajo.',
    declineReason: 'Motivo (opcional)',
    declineConfirm: 'Rechazar',
    cancel: 'Cancelar',
    doneTitle: 'Gracias. Tu firma ha quedado registrada.',
    doneAllSigned: 'Te hemos enviado por correo el documento completado y su certificado.',
    donePending: 'Recibirás el documento final por correo cuando todos los firmantes hayan terminado.',
    declinedTitle: 'Has rechazado firmar este documento.',
    declinedBody: 'Hemos avisado al remitente. Ya puedes cerrar esta ventana.',
    completedTitle: 'Este documento ya está completado.',
    completedBody: 'Revisa tu correo: allí tienes el documento sellado y su certificado.',
    closedTitle: 'Este documento ya no está disponible para firmar.',
    closedBody: 'Contacta con el remitente si crees que es un error.',
    waitTitle: 'Todavía no es tu turno de firmar.',
    waitBody: 'Recibirás un correo cuando el firmante anterior haya terminado. Puedes cerrar esta ventana.',
    errorTitle: 'Este enlace de firma no es válido.',
    errorBody: 'Puede que haya caducado o que ya se haya utilizado. Pide al remitente uno nuevo.',
